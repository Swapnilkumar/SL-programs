...
public class SeeApplet extends Applet implements ActionListener
{
	TextField t1,t2,t3;
	CheckboxGroup cbg;
	Checkbox cp,ci,cb;
	...
	// text-boxes n their labels
		...
		t1= new TextField(15);
		l2= new Label("Enter Font size: ");
		t2= new TextField(5);	
		l3= new Label("Enter Color(R-G-B): ");
		t3= new TextField(10);
	...
	// Radio Buttons
		lrad= new Label("Font style: ");
		cbg= new CheckboxGroup();
		cp= new Checkbox("Plain",cbg,true);
		...
		ci.setBounds(70,160,50,30);
		cb.setBounds(130,160,50,30);
