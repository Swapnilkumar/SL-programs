...
public class Student
{
    public static void main(String[] args)
    {
        ...
        Vector vBFarm=new Vector();
        Vector vMBBS=new Vector();
        Vector vDental=new Vector();
        do
        {
            try
            {
	...
	{			
        ...
        int cutBFarm=0,cutMBBS=0,cutDental=0;
        try 
        {
        System.out.println("\nEnter Number of students for Medical:");
        System.out.println("BFarm:");
        cutBFarm=Integer.parseInt(in3.readLine());
        System.out.println("MBBS:");
        cutMBBS=Integer.parseInt(in3.readLine());
        System.out.println("Dental:");
        cutDental=Integer.parseInt(in3.readLine());
        }
        catch(Exception e){}
        ...
        for(int i=0;i<n;i++)
        {
            obj=(Input)vMedical.elementAt(i);
            if(obj.substream.equals("BFarm"))
                    vBFarm.add(obj);
            if(obj.substream.equals("MBBS"))
                    vMBBS.add(obj);
            if(obj.substream.equals("Dental"))
                    vDental.add(obj);
        }
        ...
        b.sort(vMBBS);
        b.sort(vDental);
        System.out.println("Allotment at BFarm Dept");
        b.show(vBFarm,cutBFarm);
        System.out.println("Allotment at MBBS Dept");
        b.show(vMBBS,cutMBBS);
        System.out.println("\nAllotment at Dental Dept");
        b.show(vDental,cutDental);
